...
rem   install.bat -SetupDatabase                    (zusaetzlich Datenbank anlegen und SQL importieren)
rem ------------------------------------------------------------------
cd /d "%~dp0..\.."
...
echo.
if "%RC%"=="0" (
    echo [OK] Installation abgeschlossen. Naechste Schritte stehen oben.
) else if "%RC%"=="2" (
    echo [WARNUNG] Installation abgeschlossen, aber Ressourcen oder Datenbank sind unvollstaendig. Bitte die Warnungen oben pruefen.
) else (
